<?php
	...
	{	//Execute calculation query
		$sql = "
			...
			--Set the tap_status variable to 3 - NoTapOUT
			...
			(
				...
				WHERE (sms.tap_status = 2 OR sms.tap_status=5) AND tran_date = dateadd(day, datediff(day,0,GETDATE()),0)
			),
			Temp2 AS
			(
